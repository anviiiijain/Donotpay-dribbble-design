...
const Perks=()=>{
    ...
    return(
        <div className=" mx-auto my-16 md:my-32">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 md:grid-rows-2 md:grid-flow-col w-11/12 md:4/5 lg:w-3/5 mx-auto my-10 ">
                {theperks.map((perk,i)=>(
